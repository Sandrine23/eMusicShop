...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            <h1 style="text-align: center; font-family: 'Nova Script', cursive; font-size: 48px;">Order</h1>

            <p class="lead" style="text-align: center; font-family: 'Nova Script', cursive; font-size: 28px;">Order confirmation</p>
        </div>
                ...
                <form:form commandName="order" class="form-horizontal">
                    ...
                    <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                       ...
                       <div class="txt-center">
                           <h1 style="text-align: center;">Receipt</h1> <br/><br/>
                       </div>
